...
Product.create(image_url: "https://thumbs.dreamstime.com/b/butter-17156909.jpg" , name: "Organic Dairy Butter", description: "Produced from cream sourced from dairy animals. Rch in vitamin D and calcium for strong immunity.", price: 1500, quantity: "1Kg", category_id: 3)
...
Product.create(image_url: "https://www.shutterstock.com/image-photo/red-apple-leaf-slice-on-white-133747910" , name: "Natural Red Apple", description: "Red fruit with unbelievable taste providing you with a nutritious and tasty beverage.", price: 3500, quantity: "4Kgs", category_id: 2)
Product.create(image_url: "https://thumbs.dreamstime.com/z/carrot-vegetable-leaves-isolated-white-background-cutout-36933006.jpg" , name: "Carrot Vegetable", description: "Root vegetable rich in vitamin A, vitamin K and calcium for healthy bones and good eyesight.", price: 3000, quantity: "3Kgs", category_id: 1)
